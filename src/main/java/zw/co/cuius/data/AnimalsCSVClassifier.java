...
/**
 * This is a CSV classifier that separates the training data from the test data for the
 * classification of animals. Not only does it load CSV data into the network, it also extracts the
 * data and displays the results of the classification, as well as a method to map the labels
 * from the testing data into the results.
 *
 * @author Terrence
 */

public class AnimalsCSVClassifier {

    private static Logger log = LoggerFactory.getLogger(AnimalsCSVClassifier.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        File irisModelPath = new File(BASE_PATH + "/animals-model.zip");
        ModelSerializer.writeModel(model, irisModelPath, true);
        log.info("The Animals model has been saved in {}", irisModelPath.getPath());
        System.out.printf("The Animals model has been saved in %s", irisModelPath.getPath());
    }
     ...
     * provide some more insight on how to convert INDArray to types that are more java
     * centric.
     *
     * @param rowSlice
     * @return
