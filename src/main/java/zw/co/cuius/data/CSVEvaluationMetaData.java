...
/**
 * This is a version of the basic IrisDataSetClassification CSV example, but adds the following:
 ...
 * @author Terrence
 */
public class CSVEvaluationMetaData {

    public static void main(String[] args) throws Exception {

        //First: get the dataset using the record reader. This is as per CSV IrisDataSetClassification - see that example for details
        ...
        //Let's view the metadata in the training and test sets:
        ...
        //Normalize data as per CSV IrisDataSetClassification
